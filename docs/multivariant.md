...
The _Contracts Library_ is _multi-variant_. What does that mean?
...
The _Contracts Library_ uses these namespaces:

* `GanbaroDigital\Contracts\V1` - version 1.x of the library
* `GanbaroDigital\Contracts\V2` - reserved for version 2.x of the library
